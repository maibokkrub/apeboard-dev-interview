...
export interface AutofarmAbiInterface extends utils.Interface {
  contractName: "AutofarmAbi";
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "migrateToAUTOv2",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "owner", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "ownerAUTOReward",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "pendingAUTO",
...
export interface AutofarmAbi extends BaseContract {
  contractName: "AutofarmAbi";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutofarmAbiInterface;
