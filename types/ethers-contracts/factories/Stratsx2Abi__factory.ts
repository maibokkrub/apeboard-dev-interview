...
import type { Stratsx2Abi, Stratsx2AbiInterface } from "../Stratsx2Abi";
...
export class Stratsx2Abi__factory {
  static readonly abi = _abi;
  static createInterface(): Stratsx2AbiInterface {
    return new utils.Interface(_abi) as Stratsx2AbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Stratsx2Abi {
    return new Contract(address, _abi, signerOrProvider) as Stratsx2Abi;
  }
}
